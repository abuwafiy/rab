    ...
    <div class="col-xs-11">
          <table id="tabelku" class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    @foreach($report as $d)
                    <tr>
                        <td colspan="8" style="background-color: #dce4e8;font-weight: bold">{{ $d['nama_kategori'] }}</td>
                    </tr>
                    @isset($d['detail'])
                    @foreach($d['detail'] as $x)
                    <tr>
                        <td style="padding-left: 20px;">{{ $x['kegiatan'] }}</td>
                        <td class="text-right">{{ $x['durasi'] }}</td>
                        <td class="text-right">{{ $x['durasireal'] }}</td>
                        <td class="text-right">{{ $x['selisihhari'] }}</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <th class="text-right">{{ $summary['durasi'] }}</th>
                    <th class="text-right">{{ $summary['durasireal'] }}</th>
                    <th class="text-right">{{ $summary['selisihhari'] }}</th>
                     <th class="text-right">{{ $summary['persentase'] }}%</th>
